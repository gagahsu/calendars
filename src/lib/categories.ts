...
const KEYWORDS: Array<[CategoryKey, string[]]> = [
  ['food', ['早餐', '午餐', '晚餐', '宵夜', '午飯', '晚飯', '飲料', '咖啡', '星巴克', '便當', '小吃', '外送', 'ubereats', 'foodpanda', '拉麵', '火鍋', '吃飯', '餐廳', '手搖', '麥當勞', '超商美食', '鐵板燒', '雞蛋糕', '章魚燒', '漢堡', '鹹酥雞']],
  ['grocery', ['全聯', '家樂福', '大潤發', '好市多', 'costco', '菜', '超市', '生鮮', '日用品', '衛生紙', '全家', '7-11', '711', '超商', 'ok超商', '萊爾富']],
  ['transport', ['捷運', '公車', '高鐵', '台鐵', '火車', '計程車', 'uber', '優步', '加油', '停車', '油錢', '悠遊卡', '機車', '客運', '停車費', 'youbike', 'parking']],
  ['shopping', ['蝦皮', 'momo', 'pchome', 'coupang', '衣服', '鞋', '包', '網購', '家具', '3c', '手機', '電腦', '耳機', '化妝品', '保養品']],
